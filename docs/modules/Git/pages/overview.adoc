...
* https://github.com/thoughtbot/factory_bot_rails/blob/master/CONTRIBUTING.md[Factory Bot rails]
* https://github.com/puppetlabs/puppet/blob/main/CONTRIBUTING.md[Puppet]
